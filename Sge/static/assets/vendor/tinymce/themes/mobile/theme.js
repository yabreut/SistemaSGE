...
(function () {
    ...
    var produce$1 = function (raw) {
      var mobile = asRawOrDie$1('Getting Androidblogapp schema', MobileSchema, raw);
    ...
    function AndroidRealm (scrollIntoView) {
      ...
      var blogapp = api$2();
      var switchToEdit = makeEditSwitch(blogapp);
    ...
    var produce = function (raw) {
      var mobile = asRawOrDie$1('Getting Iosblogapp schema', MobileSchema, raw);
      set$5(mobile.toolstrip, 'width', '100%');
